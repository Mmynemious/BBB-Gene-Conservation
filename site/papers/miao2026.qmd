...
4. **The sharpest finding for this project: the divergent family is the SLC family.** A
   ...
   project's gene list is heavy with SLC transporters, and it is measuring how conserved their
   *sequence* is. Miao shows that this is exactly the family whose *expression* diverges most
